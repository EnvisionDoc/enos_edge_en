...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS Edge} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{40pt}{\baselineskip}\selectfont \textbf{Edge}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Edge',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Edge',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Edge',
