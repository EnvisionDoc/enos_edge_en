...
*Figure: Process of managing device template*
...
3. Click **Save**.
   ...
   *Figure: New Creation of Device Template*

4. Click ![](media/image037.png) of the newly adding device.
...
5. In the **Device Detail** page, you can find the following information.
   ...
   *Figure: Example of the Device Template Edit Page with Wind turbine information.*
...
2. Select the specific protocol in that type.
  ...
  *Figure: Edit Basic Information of Template*

3. (Optional)Click **Details** to check the details of the protocal.

4. (Optional) In the pop-up dialog box, click the     ![](media/image040.png) icon to view information for each protocol that helps you determine the protocol to use. If you do not find the appropriate protocol, contact the system administrator.
...
2. For each model point, click ![](media/image044.png) of in the **Mappings** column.

   ![](media/image045.png)

   *Figure: Standard Model Selection and Mapping Relation Configuration*
...
3. In the window that pops out, enter keywords of the data aquisition point in the search bar and locate the point to map to. Click **OK** to complete mapping one point.
   ...
   *Figure: Mapping Relation Configuration*
...
4. Add formula (for complicated mapping relation).
   ...
   *Figure: Formula Selection*

   The following is an example of adding the "SUM" formula.

   a.  Select **SUM** for Algorithm.

   b.  In the **Select Point** column, click ![](media/image049.png) for each point to add up.

   ![](media/image050.png)

   *Figure: The description of the formula addition*
   ...
   *Figure: Select sequence and operands*

#### Configure mapping relation in batches

1. Click **Export** to download the point mapping table.

   ![](media/image052.png)

   *Figure: Configure Mapping Relation in Batches*

   ![](media/image053.png)

   *Figure: Mapping Relation Table*
...
5. information of the model points and aquisition points can be viewed in the page, which is as shown in the following figure. Click **Save** to complete configuration of the device template.
   ...
   **Note**:
   ...
   - Not all model points need to be related to an aquisition point. Perform configuration based on your needs.
   ...
   *Figure: Configure Mapping Relation*
...
*Figure: Enter the Template Name*
...
*Figure: Target Device Template Detail Page from Device Template
Management*
...
In the **Template Lib**. page, click
![](media/image057.png) (the associate icon) to open a dialog box
to view the sites that are using the template.

![](media/image058.png)

*Figure: View the Associated Sites*
...
*Figure Select the Sites to Be Affected*
